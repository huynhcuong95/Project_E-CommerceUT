    ...
    <>
      <Routes>
        <Route element={<HomePageUser />}>
          ...
          <Route path="/product">
            <Route path="shirt" element={<Search typeCategory="shirt" />} />
            <Route path="coat" element={<Search typeCategory="coat" />} />
            <Route
              path="trousers"
              element={<Search typeCategory="trousers" />}
            />
            <Route path="dress" element={<Search typeCategory="dress" />} />
            <Route path="bikini" element={<Search typeCategory="bikini" />} />
            <Route path="shorts" element={<Search typeCategory="shorts" />} />
          </Route>
